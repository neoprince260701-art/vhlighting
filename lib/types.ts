...
export type Product={id:string;sku:string;name:string;light_color:string|null;unit:string;price:number;stock:number;created_at:string};
export type Order={
...
export type OrderItem={id?:string;order_id?:string;product_id:string|null;sku:string;product_name:string;light_color:string|null;unit:string;quantity:number;unit_price:number;line_total:number};
export type CompanySettings={
  ...
  logo_url:string|null; warranty_note:string|null; invoice_footer:string|null; invoice_creator_name:string|null;
};
